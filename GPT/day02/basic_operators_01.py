...
print("已执行数量是否等于总数量:", total_cases == excuted_cases)
print("失败数量是否大于:", fail_cases > 0)
print("通过数量是否不少于70:", excuted_cases > 70)
print("未执行数量是否小于 30:", (total_cases - excuted_cases) < 30)

progress_percent = excuted_cases / total_cases
...
print("判定请求是否失败：对“请求成功条件”使用 not 取反:", not (status_code == 200))
