...
raw_log = raw_log.strip()  # 去除两端空白
raw_log = raw_log.lower()  # 全部变为小写
raw_log = raw_log.replace("failed", "failure")
raw_log = raw_log.split("|")
print("打印拆分后的三部分:", raw_log[0], raw_log[1], raw_log[2])
print("判断第一部分是否等于error:", raw_log[0] == "error")
print("判断最后一部分是否以401结尾", raw_log[2].endswith("401"))
raw_log = "-".join(raw_log)
print("用-将三部分重新连接:", raw_log)
